...
export const PERMISSIONS = {
  ...
  'payroll.reactivate': { module: 'payroll', ar: 'إعادة فتح مسير مُرجَّع بالكامل (System Admin)', en: 'Reactivate a fully-returned batch (System Admin)' },
  'payroll.correction.create': { module: 'payroll', ar: 'إنشاء طلب تصحيح مسير مؤرشف', en: 'Create archived-payroll correction request' },
  'payroll.correction.manual': { module: 'payroll', ar: 'إدخال تصحيح يدوي (استثناء خاضع للتحكم)', en: 'Manual correction entry (controlled exception)' },
  'payroll.correction.writeOff': { module: 'payroll', ar: 'شطب استرداد سلبي (صلاحية مرتفعة)', en: 'Write off negative recovery (elevated)' },
  'payroll.correction.coApprove': { module: 'payroll', ar: 'اعتماد ثانٍ لتصحيح سلبي (Dual Approval)', en: 'Second approval for negative corrections (dual)' },
